...
const Footer = () => {
  ...
  return (
    <footer id="contact" data-cursor="contact" style={{ background: "#050505" }} className="px-6 pt-24 pb-8" ref={ref}>
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Col 2 — Contact info */}
          <div>
            <span className="font-body text-[10px] tracking-[0.15em] text-amber uppercase">Contact</span>
            <p className="font-body text-[14px] text-white mt-2">📍 Bd. Decebal 14, București</p>
            <p className="font-body text-[14px] text-white/60 mt-1">📞 +40 774 466 787</p>
